...
<div class="row">
    ...
    <div class="col-xs-12">
        <div class="row contenu">
            <div class="col-xs-12 col-md-4 text-center">
                <h3>Avant</h3>
                <img class="gimg" src="../projet%20maquette/img/test_img_1_rsz.jpg">
            ...
            <div class="col-xs-12 col-md-4 text-center">
                <h3>Après</h3>
                <img class="gimg" src="../projet%20maquette/img/test_img_2.jpg">
                <form method="post" action="modifimg.php" enctype="multipart/form-data">
    ...
    <div class="col-xs-12">
        <div class="row contenu">
            <div class="col-xs-12 col-md-4 text-center">
                <h3>Avant</h3>
                <img class="gimg" src="../projet%20maquette/img/test2_avant.jpg">
                <form method="post" action="modifimg.php" enctype="multipart/form-data">
            ...
            <div class="col-xs-12 col-md-4 text-center">
                <h3>Après</h3>
                <img class="gimg" src="../projet%20maquette/img/test2_apres.jpg">
                <form method="post" action="modifimg.php" enctype="multipart/form-data">
